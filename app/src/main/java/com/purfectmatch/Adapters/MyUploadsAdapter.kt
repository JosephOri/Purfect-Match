package com.purfectmatch.Adapters
...
import com.purfectmatch.ViewModel.MyUploadsViewModel
...
class MyUploadsAdapter(private val viewModel: MyUploadsViewModel, activity: FragmentActivity?) :
    ...
    inner class MyUploadsViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        private val deleteButton: MaterialButton = itemView.findViewById(com.purfectmatch.R.id.delete_btn)
        private val editButton: MaterialButton = itemView.findViewById(com.purfectmatch.R.id.edit_btn)

        private val image: ImageView = itemView.findViewById(com.purfectmatch.R.id.my_post_image)
        private val kindTextView: TextView = itemView.findViewById(com.purfectmatch.R.id.my_post_kind)
        private val ageTextView: TextView = itemView.findViewById(com.purfectmatch.R.id.my_post_age)
        private val aboutTextView: TextView = itemView.findViewById(com.purfectmatch.R.id.my_post_about)
        private val locationTextView: TextView =
            itemView.findViewById(com.purfectmatch.R.id.my_post_location)
        private val phoneTextView: TextView = itemView.findViewById(com.purfectmatch.R.id.my_post_phone)
        private val ownerTextView: TextView = itemView.findViewById(com.purfectmatch.R.id.my_post_owner)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyUploadsViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(com.purfectmatch.R.layout.my_post_card, parent, false)
