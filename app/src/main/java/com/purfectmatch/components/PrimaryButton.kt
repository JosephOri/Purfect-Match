package com.purfectmatch.components
...
import com.purfectmatch.R as Resources
...
private fun init() {
    ...
    val typeface: Typeface? = ResourcesCompat.getFont(context, com.purfectmatch.R.font.raleway)
